...
export default function Create({ houses }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('landlord.staff.store'));
    };
    ...
    return (
        <div className="p-6 md:p-10 max-w-2xl mx-auto font-sans">
            ...
            {/* Header */}
            <div className="mb-8">
                <h1 className="text-3xl font-extrabold text-teal-900 tracking-tight">Thêm nhân viên</h1>
                <p className="text-emerald-600/80 font-medium text-sm mt-1">Tạo tài khoản nhân viên và phân công nhà trọ</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                    ...
                    {houses.length > 0 ? (
                        ...
                        <p className="text-gray-400 text-sm text-center py-4">Chưa có nhà trọ nào. Hãy tạo nhà trọ trước.</p>
                    )}
                    {errors.house_ids && <p className="text-red-500 text-xs mt-2">{errors.house_ids}</p>}
                </div>
                ...
                <div className="flex items-center justify-end gap-3">
                    ...
                    >
                        {processing ? 'Đang tạo...' : 'Tạo nhân viên'}
                    </button>
                </div>
            </form>
        </div>
